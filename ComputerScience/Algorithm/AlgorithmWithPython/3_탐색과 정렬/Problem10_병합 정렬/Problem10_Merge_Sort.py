# Simple Merge Sort
def simple_merge_sort_min(num_list):
    """
    ...
    # 2개로 분할 후 merge sort
    mid = length//2
    group1 = simple_merge_sort_min(num_list[:mid])
    group2 = simple_merge_sort_min(num_list[mid:])
...
def Merge_sort_min(num_list):
    ...
    Merge_sort_min(sub_1)
    Merge_sort_min(sub_2)
