...
public class UploadController {
    String uploadPath = "/home/yjchoi/local-tmp/spring/uploads";

    public UploadController() {
//        File upload = new File("src/main/resources/uploads").getAbsoluteFile();
//        uploadPath = upload.getPath();
//
//        if (!upload.exists()) {
//            log.info("Following path is created - " + uploadPath + " : " + upload.mkdirs());
//        }
    }
