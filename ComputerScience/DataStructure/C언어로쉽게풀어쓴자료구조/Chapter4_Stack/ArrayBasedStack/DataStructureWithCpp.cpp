...
void ArrayBasedStackIntTest() {
	ArrayBasedStack<int> stack = ArrayBasedStack<int>(10);
...
void ArrayBasedStackClassTest() {
	ArrayBasedStack<TestPoint> stack = ArrayBasedStack<TestPoint>(10);
...
int main()
{
	//ArrayBasedStackIntTest();
	ArrayBasedStackClassTest();
