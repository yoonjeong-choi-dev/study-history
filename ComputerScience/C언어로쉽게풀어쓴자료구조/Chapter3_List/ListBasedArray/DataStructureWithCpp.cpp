...
void ListBasedArrayClassTest() {
	ListBasedArray<TestPoint>* test = new ListBasedArray<TestPoint>();
	...
	cout << "Contain 20 ? : " << test->isContained(TestPoint(5, 5)) << endl;
	cout << "Print all :" << endl;
	test->print();
...
void ListBasedArrayIntTest() {
	ListBasedArray<int>* test = new ListBasedArray<int>();
...
int main()
{
    ListBasedArrayClassTest();
    cout << endl;
    ListBasedArrayIntTest();
